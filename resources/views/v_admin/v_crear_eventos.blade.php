        ...
        <div class="form-group col-md-12">
            ...
            <div class="form row">
                <div class="form-group col-md-4">
                    ...
                    <input class="form-control" id="titulo_evento" maxlength="30" name="titulo_evento" placeholder="ingrese un titulo" type="text">
                    </input>
                </div>
                <div class="form-group col-md-4">
                ...
                <div class="form-group col-md-12">
                    <div class="box">
                        ...
                        <div class="box-body pad">
                            <!--  <form> -->
                            <textarea class="textarea" id="descripcion_evento" name="descripcion_evento" placeholder="Pon un texto aquí" style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;">
                            </textarea>
                            <!--  </form> -->
                        </div>
                    </div>
