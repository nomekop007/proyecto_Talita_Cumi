    ...
    <aside class="main-sidebar">
        ...
        <section class="sidebar">
            ...
            <ul class="sidebar-menu" data-widget="tree">
                ...
                <li><a href="{{ route('c_publicacion') }}"><i class="fa fa-link"></i> <span>Crear publicacion</span></a></li>
                <li><a href="{{ route('c_evento') }}"><i class="fa fa-link"></i> <span>Crear evento</span></a></li>
                <li><a href="{{ route('publicaciones') }}"><i class="fa fa-link"></i> <span>ver publicaciones</span></a></li>
                <li><a href="{{ route('eventos') }}"><i class="fa fa-link"></i> <span>ver eventos</span></a></li>
