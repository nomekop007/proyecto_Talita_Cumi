    ...
    <div class="page-header header-filter clear-filter menu">
        ...
        @section('boton')
            <div class="col-md-6 offset-md-3 text-right" style="position: absolute; color: white;margin-top: 30vh">
                ...
                <button style="background-color:black;color: white ; font-size: 1.5vw" type="button"
                        class="btn btn-lg float-right">CALENDARIO DE
                    EVENTOS →
                </button>
            </div>
    </div>
...
@section('contenido')
    ...
    <div class="container">
        <div class="row">
            <section class="carousel2 slide" data-ride="carousel" id="postsCarousel">
                <div class="container">
                    <div class="row">
        ...
        <l style="background-color:black"
           class="btn btn-lg float-right"><a style="color: white;"
                                             href="{{ route('vista_eventos') }}"><i
                        class="fas fa-file-upload"></i><span> VER MÁS
                    →</span></a></l>
    </div>
