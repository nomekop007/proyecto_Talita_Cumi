...
@section('header')
<header style="height: 100%;min-height: 40rem;padding-bottom: 0" class="masthead menu">
    <div class="container ">
        <div class="row h-100 align-items-center justify-content-center text-center wow">
            <div class="col-lg-12 align-self-end ">
                <h1 style="padding-top: 110px;font-family: 'Parisienne', cursive;font-size: 5.5vw;color: white">
                    <b style="color: bisque">
                        Ballet Cristiano Talita-Cumi</b></h1>
            </div>
...
<div class="container wow bounceInLeft">
    <div class="card" id="galeriaImagenes"><br>
        <h1 style="font-family: 'Montserrat', sans-serif; text-align: center" class="text-center">Galeria multimedia
        </h1>
        <div class="card-body ">
            <div class="row">
                @foreach($publicaciones as $p)
                @if( $loop->index <= 6 ) @if($p->categoria == 1)
                    @if($p->estado == 'activo')
                    @if($p->tipo == 1)
